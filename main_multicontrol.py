...
from train_multicontrol import main
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=["./sd-controlnet-canny", "./sd-controlnet-openpose"],
        nargs='+',
    ...
    para.output_dir = os.path.join(para.output_dir, f"{name}")
